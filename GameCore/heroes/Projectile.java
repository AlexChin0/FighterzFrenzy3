//This is a class which creates instances of projectiles, which are used by players and monsters to attack at range. It takes integer parameters and is
...
public class Projectile {
  ...
  //constructor takes in all necessary variables needded to create the projectile
 ...
 animation.tick();//tick the animation
    projX += speedX;//move the projectile
    projY += speedY;
    projBounds();
  }
